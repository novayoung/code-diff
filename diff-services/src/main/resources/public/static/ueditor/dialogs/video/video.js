...
(function(){
    ...
    function createPreviewVideo(url){
        ...
        // 改成用video组件渲染
        $G("preview").innerHTML = `<video class="edui-faked-video video-js" controls="" preload="metadata" width="420" height="280" src="${conUrl}">
          <source src="${conUrl}" type="video/mp4"/>
          <source src="${conUrl}" type="audio/ogg">
          <source src="${conUrl}" type="audio/mpeg">
        </video>`;
